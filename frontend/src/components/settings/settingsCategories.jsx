...
export const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'separation',
        labelKey: 'settings.separation',
        defaultLabel: 'Vocal separation',
        icon: Scissors,
        keywords: [
          'separation',
          'vocal separation',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'cloud-providers',
        labelKey: 'settings.cloud_providers',
        defaultLabel: 'Cloud providers',
        icon: Cloud,
        keywords: [
          'cloud',
          'api key',
