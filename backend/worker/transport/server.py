...
REQUIRED_FEATURES = frozenset({
    ...
    # A generic generate call on the backend accepts the same wire shape but
    # drops profile conditioning controls. Require the canonical worker render
    # path so an older peer cannot successfully return a different voice.
